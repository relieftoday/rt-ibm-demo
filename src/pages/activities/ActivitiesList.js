...
export default function EnhancedTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = activities.map((n) => n.name);
    ...
    <div className={classes.root}>
      <div className={classes.header}>
        <Breadcrumbs aria-label="breadcrumb">
          <Typography color="textPrimary" variant="h4">Events</Typography>
        </Breadcrumbs>
        <div className={classes.grow}></div>
        <RouterLink to="/activities/add">
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.provider.address}</TableCell>
                      <TableCell align="left">{row.time}</TableCell>
                      <TableCell align="left">{row.provider.activityType + " Drive"}</TableCell>
                      <TableCell align="left">{row.provider.needVolunteers ? "Yes" : "No"}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
